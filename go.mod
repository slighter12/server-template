...
require (
	...
	github.com/slighter12/go-lib/database/mongo v1.0.0
	github.com/slighter12/go-lib/database/mysql v1.0.0
	github.com/slighter12/go-lib/database/postgres v1.0.0
	github.com/slighter12/go-lib/database/redis/cluster v1.0.0
