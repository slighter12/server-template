...
type GoFeatures struct {
	...
	xxx_hidden_LegacyUnmarshalJsonEnum bool                       `protobuf:"varint,1,opt,name=legacy_unmarshal_json_enum,json=legacyUnmarshalJsonEnum" json:"legacy_unmarshal_json_enum,omitempty"`
	xxx_hidden_ApiLevel                GoFeatures_APILevel        `protobuf:"varint,2,opt,name=api_level,json=apiLevel,enum=pb.GoFeatures_APILevel" json:"api_level,omitempty"`
	xxx_hidden_StripEnumPrefix         GoFeatures_StripEnumPrefix `protobuf:"varint,3,opt,name=strip_enum_prefix,json=stripEnumPrefix,enum=pb.GoFeatures_StripEnumPrefix" json:"strip_enum_prefix,omitempty"`
...
func (x *GoFeatures) GetLegacyUnmarshalJsonEnum() bool {
	if x != nil {
		return x.xxx_hidden_LegacyUnmarshalJsonEnum
	}
	return false
}
...
func (x *GoFeatures) GetStripEnumPrefix() GoFeatures_StripEnumPrefix {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 2) {
			return x.xxx_hidden_StripEnumPrefix
		}
	}
	return GoFeatures_STRIP_ENUM_PREFIX_UNSPECIFIED
}

func (x *GoFeatures) SetLegacyUnmarshalJsonEnum(v bool) {
	x.xxx_hidden_LegacyUnmarshalJsonEnum = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 3)
}

func (x *GoFeatures) SetApiLevel(v GoFeatures_APILevel) {
	x.xxx_hidden_ApiLevel = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 1, 3)
}

func (x *GoFeatures) SetStripEnumPrefix(v GoFeatures_StripEnumPrefix) {
	x.xxx_hidden_StripEnumPrefix = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 2, 3)
}

func (x *GoFeatures) HasLegacyUnmarshalJsonEnum() bool {
	if x == nil {
		return false
	}
...
func (x *GoFeatures) HasApiLevel() bool {
	if x == nil {
		return false
	}
...
func (x *GoFeatures) HasStripEnumPrefix() bool {
	if x == nil {
		return false
	}
...
func (x *GoFeatures) ClearLegacyUnmarshalJsonEnum() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_LegacyUnmarshalJsonEnum = false
}

func (x *GoFeatures) ClearApiLevel() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_ApiLevel = GoFeatures_API_LEVEL_UNSPECIFIED
}

func (x *GoFeatures) ClearStripEnumPrefix() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_StripEnumPrefix = GoFeatures_STRIP_ENUM_PREFIX_UNSPECIFIED
}

type GoFeatures_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// Whether or not to generate the deprecated UnmarshalJSON method for enums.
	// Can only be true for proto using the Open Struct api.
	LegacyUnmarshalJsonEnum *bool
	// One of OPEN, HYBRID or OPAQUE.
	ApiLevel        *GoFeatures_APILevel
	StripEnumPrefix *GoFeatures_StripEnumPrefix
}

func (b0 GoFeatures_builder) Build() *GoFeatures {
	m0 := &GoFeatures{}
	b, x := &b0, m0
	_, _ = b, x
	if b.LegacyUnmarshalJsonEnum != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 3)
		x.xxx_hidden_LegacyUnmarshalJsonEnum = *b.LegacyUnmarshalJsonEnum
	}
	if b.ApiLevel != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 1, 3)
		x.xxx_hidden_ApiLevel = *b.ApiLevel
	}
	if b.StripEnumPrefix != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 2, 3)
		x.xxx_hidden_StripEnumPrefix = *b.StripEnumPrefix
	}
	return m0
}
